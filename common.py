...
class EnvBase(nn.Module, metaclass=_EnvPostInit):
    ...
    def _step_mdp(self):
        ...
        if step_func is None:
            step_func = _StepMDP(self, exclude_action=False, exclude_reward=False)
    ...
    def _rollout_stop_early(
        ...
        *,
        ...
        for i in range(max_steps):
            ...
            if tensordict['next']['reward'].item() == 1.0:
                td_append.set("reward", torch.tensor([1.0]))
    ...
    def _rollout_nonstop(
        ...
        *,
        ...
        for i in range(max_steps):
            ...
            if tensordict['next']['reward'].item() == 1.0:
                tensordict.set("reward", torch.tensor([1.0]))
