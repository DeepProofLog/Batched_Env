...
Examples:
  ...
  python runner_pykeen_v2.py --model ComplEx --dataset family
  
  # Train multiple models
  python runner_pykeen_v2.py --models ComplEx,TransE,RotatE --dataset family
  
  # Train all models
  python runner_pykeen_v2.py --models all --dataset wn18rr
  
  # Custom hyperparameters
  python runner_pykeen_v2.py --model ComplEx --dataset family --epochs 2000 --lr 0.001
  
  # Hyperparameter search
  python runner_pykeen_v2.py --hparam_search --hparam_config hparam_config.json
  
  # Save models and results
  python runner_pykeen_v2.py --models all --dataset family --save_models --results results.json
        """
    ...
    def train_single_model(
        ...
        **kwargs
        ...
        data_dir = base_dir / 'data' / config.dataset if config.use_local else None
        save_dir = base_dir / config.save_dir / 'pykeen' if config.save_models else None
