"""Profile minimal eval V10 with EngineWrapper."""
import os
import sys
...
def setup(device, config):
    ...
    from eval_minimal_v10 import MinimalEvalV10
...
def main():
    ...
    print(f"Minimal Eval V10 | Candidates: {total}, Batch: {config.batch_size}")
    ...
    t0 = time()
    c['eval'].engine.compile(mode='reduce-overhead')  # Compile engine first
