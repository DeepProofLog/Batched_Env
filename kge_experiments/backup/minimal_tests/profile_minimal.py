"""Profile minimal standalone evaluation."""
import os
import sys
...
def setup(device, config):
    ...
    from eval_minimal import MinimalEval
...
def main():
    ...
    print(f"Minimal Eval | Candidates: {total}, Batch: {config.batch_size}")
