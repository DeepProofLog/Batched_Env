"""Profile minimal eval V8 - hybrid torch.compile + CUDA graph."""
import os
import sys
...
def setup(device, config):
    ...
    from eval_minimal_v8 import MinimalEvalV8
...
def main():
    ...
    print(f"Minimal Eval V8 | Candidates: {total}, Batch: {config.batch_size}")
    ...
    t0 = time()
    c['eval'].compile(mode='max-autotune')
