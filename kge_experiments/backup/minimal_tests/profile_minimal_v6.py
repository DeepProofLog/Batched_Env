"""Profile minimal eval V6 - zero-arg step with double buffering."""
import os
import sys
...
def setup(device, config):
    ...
    from eval_minimal_v6 import MinimalEvalV6
...
def main():
    ...
    print(f"Minimal Eval V6 | Candidates: {total}, Batch: {config.batch_size}")
