...
def setup(device, config):
    ...
    from eval_minimal_v2 import MinimalEvalV2
...
def main():
    ...
    print(f"Minimal Eval V2 | Candidates: {total}, Batch: {config.batch_size}")
