"""Profile minimal eval V3 with torch.compiler.disable."""
import os
import sys
...
def setup(device, config):
    ...
    from eval_minimal_v3 import MinimalEvalV3
    ...
    evaluator = MinimalEvalV3(
        policy=policy, engine=vec_engine, batch_size=config.batch_size,
...
def main():
    ...
    print(f"Minimal Eval V3 | Candidates: {total}, Batch: {config.batch_size}")
