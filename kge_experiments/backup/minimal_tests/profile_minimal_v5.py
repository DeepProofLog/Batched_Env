"""Profile minimal eval V5 - pure functional, no CUDA breaks."""
import os
import sys
...
def setup(device, config):
    ...
    from eval_minimal_v5 import MinimalEvalV5
...
def main():
    ...
    print(f"Minimal Eval V5 | Candidates: {total}, Batch: {config.batch_size}")
