"""Profile minimal eval V9 - buffer-copy pattern from env.py."""
import os
import sys
...
def setup(device, config):
    ...
    from eval_minimal_v9 import MinimalEvalV9
...
def main():
    ...
    print(f"Minimal Eval V9 | Candidates: {total}, Batch: {config.batch_size}")
